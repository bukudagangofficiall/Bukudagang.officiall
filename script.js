...
function renderAttendanceRequiredToggle() {
    ...
    if (!isAdminSubscribed) {
        ...
        if (note) note.innerHTML = 'Fitur QR Absen butuh <b>langganan aktif</b>. Selama belum langganan, kasir bisa langsung pakai POS setelah login PIN tanpa perlu absen dulu.';
        lucide.createIcons();
        return;
    }
